...
public class ComparatorDemo {
    ...
    public static void main(String[] args) {
        ...
        addresses.add(new Address("383 Coolidge Dr", "Angola", "NY", "14006"));
        addresses.add(new Address("187 Pleasant Ave", "Hamburg", "NY", "14006"));
        addresses.add(new Address("105 Farmhouse Loop", "Lexington", "SC", "20072"));
